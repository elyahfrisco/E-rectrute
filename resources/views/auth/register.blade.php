...
@section('content')
<h1 class="text-3xl text-green-500 mb-6 text-center"  style="font-family: cursive;font-size: 25px">Completez vos informations</h1>
<form method="POST" action="{{ route('register') }}" class="w-full max-w-sm mx-auto rounded-lg border shadow-md p-5 mb-5">
    @csrf
    <div class="mb-4">
        <label for="name" class="block font-semibold text-gray-700 mb-2" style="font-family: ui-monospace;font-size: 17px">Nom d'utilisateur</label>
    ...
    <div class="mb-4">
        <label for="email" class="block font-semibold text-gray-700 mb-2" style="font-family: ui-monospace;font-size: 17px">Email</label>
    ...
    <div class="mb-4">
        <label for="password" class="block font-semibold text-gray-700 mb-2" style="font-family: ui-monospace;font-size: 17px">Mot de passe</label>
    ...
    <div class="mb-4">
        <label for="password_confirmation" class="block font-semibold text-gray-700 mb-2" style="font-family: ui-monospace;font-size: 17px">Confirmation du mot de passe</label>
     ...
     {{-- <p for="role-select" class="font-semibold text-gray-700" style="font-family: ui-monospace;font-size: 17px">Je veux être :</p>
    ...
    <input type="hidden" name="role_id" id="" value="1">
    @error('role_id')
