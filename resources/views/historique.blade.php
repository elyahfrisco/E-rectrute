  ...
  <body>
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li>
            <a href="{{route('histo')}}" class="active">
                          ...
                          <div class="table-responsive bg-white">
                            <table class="table mb-0">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td>{{$historiques->utisateur}}</td>
                                  <td>{{$historiques->evenement}}</td>
                                  <td>{{$historiques->created_at}}</td>
                                  
                                </tr>
                                @endforeach
                              </tbody>
                            </table>
                            <div class="d-flex justify-content-center"> {{$historique->links() }} </div>
                          </div>
                        </div>
                      </div>
                    </div>
